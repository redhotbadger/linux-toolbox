...
dconf write /org/gnome/shell/app-picker-layout "[{'steam.desktop': <{'position': <0>}>, 'codium-wayland.desktop': <{'position': <1>}>, 'veracrypt.desktop': <{'position': <2>}>, 'org.gnome.Totem.desktop': <{'position': <3>}>, 'org.gnome.gedit.desktop': <{'position': <4>}>, 'github-desktop.desktop': <{'position': <5>}>, 'fr.handbrake.ghb.desktop': <{'position': <6>}>, 'makemkv.desktop': <{'position': <7>}>, 'org.gnome.Meld.desktop': <{'position': <8>}>, 'Utilities': <{'position': <9>}>, 'Settings': <{'position': <10>}>, 'Development': <{'position': <11>}>, 'System': <{'position': <12>}>}]"
